...
('subtype_004', 'Server-type-2', 'Physical or virtual server hardware', TO_TIMESTAMP_LTZ('2024-01-15 10:10:00', 'yyyy-MM-dd HH:mm:ss'));
...
('asset_001', 'subtype_004', 1,TO_TIMESTAMP_LTZ('2024-01-16 09:00:00', 'yyyy-MM-dd HH:mm:ss')),
