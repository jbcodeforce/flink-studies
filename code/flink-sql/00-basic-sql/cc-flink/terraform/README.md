...
Alternatively, from `00-basic-sql/` run `make sync` then `make deploy-customers` (see [`deploy_manifest.json`](deploy_manifest.json) and [`../../tools/README.md`](../../tools/README.md)).
