#!/usr/bin/env python3
"""
Deploy same employee SQLs to Confluent Platform Flink (CMF) and validate end-to-end.
...
def run_ddl(base_url: str, name: str, sql_file: str) -> None:
...
def main() -> None:
    ...
    if args.ddl_only:
        print("=== Deploying DDL ===")
        run_ddl(base_url, "ddl-employees", "cc-flink/ddl.employee.sql")
        return

    # Full flow
    print("=== Deploying DDL ===")
    run_ddl(base_url, "ddl-employees", "cp-flink/ddl.employee.sql")
