# Reefer Anomaly Detection — Confluent Cloud

## Goal

Deploy Flink SQL on Confluent Cloud for the `reefer-sensors` stream and downstream processing.
...
```sql
SELECT * FROM reefer_sensor LIMIT 10;
```
