...
Full procedure and tooling notes: [blue/green deployment](https://jbcodeforce.github.io/shift_left_utils/blue_green_deploy/). Pipeline interdependence design: [pipeline management](https://jbcodeforce.github.io/shift_left_utils/pipeline_mgr/).
